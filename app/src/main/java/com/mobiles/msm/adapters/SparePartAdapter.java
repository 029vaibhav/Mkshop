...
import com.mobiles.msm.fragments.SparePartListItemFragment;
...
public class SparePartAdapter extends RecyclerView.Adapter<SparePartAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View convertView) {
            ...
            if (MyApplication.Role != null && UserType.valueOf(MyApplication.Role.toUpperCase()) != UserType.TECHNICIAN)
