...
import com.mobiles.msm.application.CircleImageView;
import com.mobiles.msm.application.Client;
import com.mobiles.msm.application.MyApplication;
import com.mobiles.msm.fragments.AttendanceThroughWifi;
import com.mobiles.msm.fragments.ExpenseManagerFragment;
import com.mobiles.msm.fragments.GeoPointsFragment;
import com.mobiles.msm.fragments.Incentive;
import com.mobiles.msm.fragments.LeaderBoardFragment;
import com.mobiles.msm.fragments.OffersFragment;
import com.mobiles.msm.fragments.SparePartFragment;
import com.mobiles.msm.fragments.ProfileFragment;
import com.mobiles.msm.fragments.RequestRepair;
import com.mobiles.msm.fragments.RevenueCompatorFragment;
import com.mobiles.msm.fragments.SaleFragment;
import com.mobiles.msm.fragments.SalesReport;
import com.mobiles.msm.fragments.SendNotificationFragment;
import com.mobiles.msm.fragments.ServiceReport;
import com.mobiles.msm.fragments.SplashFragment;
import com.mobiles.msm.fragments.UserListFragment;
import com.mobiles.msm.fragments.UserSalesService;
import com.mobiles.msm.fragments.ViewProductFragment;
import com.mobiles.msm.gcm.RegistrationIntentService;
...
public class NavigationMenuActivity extends AppCompatActivity
    ...
    protected void navigation() {
        ...
        if (loginDetailsList != null) {
            MyApplication.Role = loginDetailsList.getUser().getRole();
            ...
            setMenuAccordingToRole(MyApplication.Role, navigationView);
        } else {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.logOut) {
            ...
            Call<Void> logout = Client.INSTANCE.logout(MyApplication.Username);
            logout.enqueue(new Callback<Void>() {
                ...
                public void onFailure(Call<Void> call, Throwable t) {
                    ...
                    MyApplication.toast(NavigationMenuActivity.this, t.getMessage());
            ...
            if (fragment == null) {
                fragment = ProfileFragment.newInstance(MyApplication.Username);
            }
...
//        Crashlytics.setUserIdentifier(MyApplication.Role);
//        Crashlytics.setUserName(MyApplication.Username);
    }
