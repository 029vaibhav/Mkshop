...
public class DealerReportViewPagerFragment extends Fragment implements View.OnClickListener {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (amount.getText().length() == 0) {
                    MyApplication.toast(getActivity(), "amount cant be blank");
                } else if (note.getText().length() == 0) {
                    MyApplication.toast(getActivity(), "note cant be blank");
                } else {
    ...
    private void sendDataToServer(Payment payment) {
        ...
        Call<Payment> paymentCall = Client.INSTANCE.duePayment(MyApplication.AUTH, payment);
        paymentCall.enqueue(new Callback<Payment>() {
            ...
            public void onResponse(Call<Payment> call, Response<Payment> response) {
                ...
                MyApplication.toast(getActivity(), "payment successful");
