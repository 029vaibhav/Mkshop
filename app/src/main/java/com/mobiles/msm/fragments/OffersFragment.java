...
import com.mobiles.msm.adapters.NotificationAdapter;
...
public class OffersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        materialDialog.show();
        Client.INSTANCE.getNotificationDetail(MyApplication.AUTH, MyApplication.Role).enqueue(new Callback<List<Message>>() {
            @Override
