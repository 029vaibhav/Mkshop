...
import com.mobiles.msm.adapters.IncentiveUserlistDialogAdapter;
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (amount.getText().length() != 0) {
                    ...
                    Call<EmployeeExpense> stringCall = Client.INSTANCE.payUserIncentive(MyApplication.AUTH, employeeExpense);
                    ...
                    MyApplication.toast(getActivity(), "please enter the incentive amount");
                }
