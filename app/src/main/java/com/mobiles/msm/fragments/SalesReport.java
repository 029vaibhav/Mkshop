...
import com.mobiles.msm.adapters.SalesReportItemAdapter;
import com.mobiles.msm.adapters.TabsPagerAdapter;
...
public class SalesReport extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        MyApplication.SCRREN = "SalesReport";
    ...
    private void executeQuery() {
        ...
        Client.INSTANCE.getSalesReport(MyApplication.AUTH, sFromdate, sToDate).enqueue(new Callback<List<Sales>>() {
            @Override
