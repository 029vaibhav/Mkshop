...
import com.mobiles.msm.adapters.ServiceCenterAdapter;
...
public class RequestRepair extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        MyApplication.SCRREN = "RequestRepair";
...
//        fab.attachToListView(listView);
    ...
    private void listInitializer() {
        ...
        Client.INSTANCE.getServiceList(MyApplication.AUTH).enqueue(new Callback<List<ServiceCenterEntity>>() {
            @Override
