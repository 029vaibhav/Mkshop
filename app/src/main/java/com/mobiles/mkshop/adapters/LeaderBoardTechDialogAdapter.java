 ...
 */
public class LeaderBoardTechDialogAdapter extends RecyclerView.Adapter<LeaderBoardTechDialogAdapter.ViewHolder> {

    Fragment context;
    List<ServiceCenterEntity> sales;

    public LeaderBoardTechDialogAdapter(Fragment context, List<ServiceCenterEntity> sales) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        ServiceCenterEntity leaderBoardDetails = sales.get(position);

        if (leaderBoardDetails.getModel() != null)
        ...
        if (leaderBoardDetails.getProblem() != null) {
