            ...
            public boolean onLongClick(View v) {
                ...
                builder.setItems(R.array.delete, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int item) {
                        ...
                        Client.INSTANCE.deleteIncentiveMessage(MkShop.AUTH, incentiveEntity.getId()).enqueue(new Callback<IncentiveEntity>() {
                            @Override
                            public void onResponse(Call<IncentiveEntity> call, Response<IncentiveEntity> response) {
                                MkShop.toast(context.getActivity(), "Deleted Successfully");
